...
final class ZenithTheme {
  ...
  static ThemeData light() => _theme(
    ...
    colorScheme: ColorScheme.light(
      ...
      errorContainer: const Color(0xFFFCE8E9),
      ...
      surfaceContainerHigh: const Color(0xFFF4F4F4),
      outline: const Color(0xFFD1D1D1),
      outlineVariant: const Color(0xFFE7E7E7),
    ),
  );
  ...
  static ThemeData dark() => _theme(
    ...
    colorScheme: ColorScheme.dark(
      ...
      tertiary: _statusWarning,
      onTertiary: Colors.white,
      tertiaryContainer: const Color(0x28C97A12),
      onTertiaryContainer: const Color(0xFFF4F4F4),
      error: _zpRedDark,
      onError: Colors.white,
      errorContainer: const Color(0x24E83239),
      onErrorContainer: const Color(0xFFF4F4F4),
      ...
      outline: const Color(0xFF353535),
