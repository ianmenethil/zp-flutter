...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        // Keeps the banner + form mobile-sized on web/desktop while the
        // AppBar and page background stay full-width, matching how the
        // Scaffold paints its Material background/safe areas.
