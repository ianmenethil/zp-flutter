...
export class ZenpayBackendContainer extends Container {
  ...
  envVars = {
    ...
    RECAPTCHA_SITE_KEY_WEB: this.env.RECAPTCHA_SITE_KEY_WEB,
    ...
    RECAPTCHA_PROJECT_NUMBER: this.env.RECAPTCHA_PROJECT_NUMBER,
    RECAPTCHA_SERVICE_ACCOUNT_JSON: this.env.RECAPTCHA_SERVICE_ACCOUNT_JSON,
  };
}
